...
#from django.contrib.auth.decorators import views

urlpatterns = [
    
    path('admin/', admin.site.urls),
    path('', auth_views.LoginView.as_view(), name='root'),
    path('accounts/login/', auth_views.LoginView.as_view(), name='login'),
    path('accounts/logout/', auth_views.LogoutView.as_view(next_page='/'), name='logout'),
    path('consulta/', include('cartografia.urls')),
    #autenticacion con django rest jwt y django restframework  
